...
class User
{
    ...
    {
        try {
            $sql = "INSERT INTO users (user_fullname, email, password, created_at, profile_photo) VALUES (:user_fullname, :email, :password, NOW(), :profile_photo)";
    ...
    {
        try {
            $sql = "SELECT user_fullname, email, profile_photo FROM users WHERE id = :id";
